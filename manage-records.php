			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="addRecordForm" data-toggle="validator" role="form">
									...
									<div class="form-group">
										...
										<input name="depreciation-rate" type="text" class="form-control">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="no-of-items">Condition: </label>
									...
									<br>
									<button class="btn btn-success pull-right">Add Record</button>
								</form>
							</div>
						</div>
					</div>
